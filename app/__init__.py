...
def create_app():
    ...
    logger.info("Создание экземпляра приложения Flask.")
    ...
    try:
        ...
        jwt = JWTManager(app)
        logger.info("JWT инициализирован.")
    except Exception as e:
    ...
    try:
        ...
        logger.info("Настройки OpenAI загружены.")
    except Exception as e:
        logger.error(f"Ошибка при загрузке настроек OpenAI: {e}")
        raise
    ...
    try:
        ...
        logger.info("Настройки s3 хранилища загружены.")
    except Exception as e:
        logger.error(f"Ошибка при загрузке настроек s3 хранилища: {e}")
        raise
    ...
    try:
        ...
        logger.info("Google OAuth инициализирован.")
    except Exception as e:
        logger.error(f"Ошибка при регистрации Google OAuth: {e}")
        raise
    ...
    try:
        init_openai(app)
        logger.info("OpenAI успешно инициализирован.")
    except Exception as e:
    ...
    try:
        init_s3_manager(app)
        logger.info("s3 хранилище успешно инициализировано.")
    except Exception as e:
    ...
    logger.info("Маршрут Google Auth успешно зарегистрирован.")
